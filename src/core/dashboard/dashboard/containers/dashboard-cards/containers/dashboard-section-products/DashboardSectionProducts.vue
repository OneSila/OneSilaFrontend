...
const productErrors = ref([
  ...
  { errorCode: 103, importance: 'high', icon: 'exclamation-triangle', color: 'red', counter: 0, loading: true  },
  ...
  { errorCode: 107, importance: 'high', icon: 'exclamation-triangle', color: 'red', counter: 0, loading: true  },
  { errorCode: 108, importance: 'high', icon: 'exclamation-triangle', color: 'red', counter: 0, loading: true  },
  ...
  { errorCode: 113, importance: 'medium', icon: 'exclamation-circle', color: 'orange', counter: 0, loading: true  },
  { errorCode: 114, importance: 'medium', icon: 'exclamation-circle', color: 'orange', counter: 0, loading: true  },
  { errorCode: 115, importance: 'medium', icon: 'exclamation-circle', color: 'orange', counter: 0, loading: true  },
  ...
  { errorCode: 119, importance: 'low', icon: 'info-circle', color: 'yellow', counter: 0, loading: true  },
  ...
  { errorCode: 122, importance: 'low', icon: 'info-circle', color: 'yellow', counter: 0, loading: true  },
  ...
  <Card v-if="!hideProductsSection" class="py-8 mt-4">
      ...
      <div class="cards grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-4">
          <DashboardCard
            ...
            :loading="err.loading"
            :url="{ name: 'products.products.list', query: {inspectorNotSuccefullyCodeError: err.errorCode } }"
            :color="err.color"
            :icon="err.icon"
          />
      </div>
