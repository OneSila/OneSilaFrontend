...
import {baseFormConfigConstructor as basePersonConfigConstructor } from '../../../../contacts/people/configs'
...
export const baseFormConfigConstructor = (
  ...
  submitUrl: { name: 'settings.internalCompany.show', params: {id: companyId }, query: {tab: 'addresses'}},
  fields: [
    {
      type: FieldType.Hidden,
      name: 'company',
...
export const listingConfigConstructor = (t: Function, id: string): ListingConfig => ({
  ...
  addActions: true,
  addEdit: true,
  editUrlName: 'settings.companies.address.edit',
  addShow: false,
  addDelete: true,
  addPagination: true,
