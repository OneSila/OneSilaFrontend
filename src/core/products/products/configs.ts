...
export const searchConfigConstructor = (t: Function, hasAmazon: boolean = false): SearchConfig => ({
  ...
  filters: [
    ...
    },
    {
      type: FieldType.Boolean,
      strict: true,
      name: 'hasMultipleConfigurableParents',
      label: t('products.products.filters.labels.usedInMultipleConfigurables'),
    },
    {
      type: FieldType.Boolean,
      strict: true,
      name: 'isMultipleParent',
      label: t('products.products.filters.labels.isMultipleParent'),
    },
    {
      type: FieldType.Query,
      name: 'variationOfProductId',
      query: productsQuerySelector,
      label: t('products.products.filters.labels.variationOfProduct'),
      labelBy: "name",
      valueBy: "id",
      dataKey: "products",
      filterable: true,
      ...
      isEdge: true,
      addLookup: false,
      placeholder: t('products.products.filters.placeholders.variationOfProduct'),
    },
    {
      type: FieldType.Boolean,
      strict: true,
  ...
  filterSections: [
    {
      ...
      filters: [
        ...
        'updatedAtRange',
        'hasEanCodes',
        'hasMultipleConfigurableParents',
        'isMultipleParent',
