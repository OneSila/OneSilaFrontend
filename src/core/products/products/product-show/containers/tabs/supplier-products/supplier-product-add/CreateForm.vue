...
const props = defineProps<{ product: Product, form: ProductForm; supplierProducts: SupplierProduct[] }>();
const products = ref([]);
...
const fetchData = async () => {
  loading.value = true;
  const ids = props.supplierProducts.map(supplierProduct => ( supplierProduct.id ));
