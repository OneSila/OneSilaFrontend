export const routes = [
  ...
  {
    path: '/integrations/:type/:integrationId?/store/:id',
  ...
  {
    path: '/integrations/:type/:integrationId?/store/create',
  ...
  {
    path: '/integrations/:type/:integrationId?/language/:id',
  ...
  {
    path: '/integrations/:type/:integrationId?/currency/:id',
  ...
  {
    path: '/integrations/:type/:integrationId?/price-list/create',
  ...
  {
    path: '/integrations/:type/:integrationId?/product-type/:id',
  ...
  {
    path: '/integrations/:type/:integrationId?/document-type/:id',
  ...
  {
    path: '/integrations/:type/:integrationId?/property/:id',
  ...
  {
    path: '/integrations/:type/:integrationId?/internal-property/:id',
  ...
  {
    path: '/integrations/:type/:integrationId?/property-value/:id',
  ...
  {
    path: '/integrations/:type/:integrationId?/amazon-default-unit-configurator/:id',
  ...
  {
    path: '/integrations/:type/:integrationId?/mirakl-default-unit-configurator/:id',
  ...
  {
    path: '/integrations/:type/:integrationId?/import/create',
  ...
  {
    path: '/integrations/:type/:integrationId?/import-process/:id',
  ...
  {
    path: '/integrations/:type/:integrationId?/mirakl-import-process/:id',
  ...
  {
    path: '/integrations/:type/:integrationId?/amazon-issues/:issueId',
  ...
  {
    path: '/integrations/:type/:integrationId?/mirakl-issues/:issueId',
