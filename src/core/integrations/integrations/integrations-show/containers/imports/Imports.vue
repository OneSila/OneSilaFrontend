...
import { AmazonImportsListing, EbayImportsListing, SheinImportsListing, MiraklImportsListing, GeneralImportsListing } from './components';
...
const isMirakl = computed(() => type.value === IntegrationTypes.Mirakl);
</script>
...
<template>
  ...
  <MiraklImportsListing v-else-if="isMirakl" :id="id" :sales-channel-id="salesChannelId" />
