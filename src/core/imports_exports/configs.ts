...
export const EXPORT_KIND_COLUMNS: Record<ExportKind, string[]> = {
  ...
  images: ['image_url', 'type', 'title', 'description', 'product_data', 'product_sku', 'sort_order', 'is_main_image'],
  documents: ['document_url', 'type', 'title', 'description', 'product_data', 'product_sku', 'sort_order', 'document_type', 'document_language', 'thumbnail_image', 'is_document_image'],
  videos: ['video_url', 'type', 'title', 'description', 'product_data', 'product_sku', 'sort_order'],
  sales_prices: ['rrp', 'price', 'currency', 'product_data', 'product_sku'],
  price_lists: ['name', 'start_date', 'end_date', 'currency', 'vat_included', 'auto_update_prices', 'auto_add_products', 'price_change_pcnt', 'price_fixed_modifier', 'discount_pcnt', 'discount_price_fixed_modifier', 'notes', 'sales_pricelist_items'],
...
export const EXPORT_KIND_DEFAULT_COLUMNS: Record<ExportKind, string[]> = {
  ...
  price_lists: ['name', 'start_date', 'end_date', 'currency', 'vat_included', 'auto_update_prices', 'auto_add_products', 'price_change_pcnt', 'price_fixed_modifier', 'discount_pcnt', 'discount_price_fixed_modifier', 'notes'],
